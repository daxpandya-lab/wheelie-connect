...
import { Users, Wrench, Car, MessageSquare, TrendingUp, Clock, CheckCircle, Target } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const fetchDashboard = useCallback(async () => {
    ...
    const [customersRes, bookingsRes, testDrivesRes, convosRes, leadsRes] = await Promise.all([
    ...
    <>
      ...
      <div className="flex-1 overflow-y-auto p-6 space-y-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <KpiCard title="Service Bookings" value={kpis.bookings.toLocaleString()} change={`${kpis.todayBookings} today`} changeType="neutral" icon={Wrench} delay={100} />
          ...
          <div className="glass-card rounded-xl p-5">
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Clock, label: "Today's Bookings", value: kpis.todayBookings.toLocaleString(), color: "text-warning" },
