...
export const SERVICE_BOOKING_FLOW: FlowData = {
  ...
  nodes: [
    ...
    },
    {
      ...
      message: {
        en: "Got it! Your vehicle is scheduled for {{preferred_date}}. You can bring it in for morning drop-off anytime between 9:00 AM and 12:00 PM.",
        hi: "समझ गया! आपका वाहन {{preferred_date}} के लिए शेड्यूल है। आप सुबह 9:00 से 12:00 बजे के बीच कभी भी ड्रॉप-ऑफ कर सकते हैं।",
        ar: "تم! سيارتك مجدولة في {{preferred_date}}. يمكنك إحضارها للتسليم الصباحي في أي وقت بين 9:00 صباحًا و12:00 ظهرًا.",
      },
    ...
    },
    {
      ...
      validationType: "selection",
      options: [
        { label: "Yes, both pickup & drop", value: "both", nextNodeId: "ask_address" },
        { label: "Pickup only", value: "pickup", nextNodeId: "ask_address" },
        { label: "Drop only", value: "drop", nextNodeId: "ask_address" },
    ...
    },
    {
      id: "ask_address",
      type: "question",
      label: "Ask Pickup/Drop Address",
      message: {
        en: "Please share your full pickup/drop address (with landmark, area, city).",
        hi: "कृपया अपना पूरा पिकअप/ड्रॉप पता साझा करें (लैंडमार्क, क्षेत्र, शहर सहित)।",
        ar: "يرجى مشاركة عنوان الاستلام/التسليم الكامل (مع المعلم والمنطقة والمدينة).",
      },
      dataField: "pickup_address",
      validationType: "text",
      nextNodeId: "confirm_booking",
      position: { x: 400, y: 1175 },
    },
    {
      id: "confirm_booking",
      type: "confirmation",
  ...
  connections: [
    ...
    { id: "c16a", sourceId: "ask_pickup", targetId: "ask_address", label: "with pickup/drop" },
    { id: "c16b", sourceId: "ask_pickup", targetId: "confirm_booking", label: "no pickup" },
    { id: "c16c", sourceId: "ask_address", targetId: "confirm_booking" },
...
export const RESCHEDULE_SERVICE_FLOW: FlowData = {
  ...
  nodes: [
    ...
    },
    {
      ...
      label: "Ask Pickup/Drop",
      message: {
        en: "Got it! Your vehicle is scheduled for {{preferred_date}}. You can bring it in for morning drop-off anytime between 9:00 AM and 12:00 PM.\n\nDo you need vehicle pickup and drop service for the new appointment?",
        hi: "समझ गया! आपका वाहन {{preferred_date}} के लिए शेड्यूल है। आप सुबह 9:00 से 12:00 बजे के बीच कभी भी ड्रॉप-ऑफ कर सकते हैं।\n\nक्या आपको नई अपॉइंटमेंट के लिए पिकअप/ड्रॉप चाहिए?",
        ar: "تم! سيارتك مجدولة في {{preferred_date}}. يمكنك إحضارها للتسليم الصباحي بين 9:00 صباحًا و12:00 ظهرًا.\n\nهل تحتاج إلى خدمة استلام/تسليم للموعد الجديد؟",
      },
      dataField: "pickup_required",
      validationType: "selection",
      options: [
